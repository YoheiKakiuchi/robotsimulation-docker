...
${BUILD_CMD} build ${DOCKER_BUILD_OPTION} -f Dockerfile.choreonoid.${UBUNTU_VERSION}_${CHOREONOID_VERSION} \
...
${BUILD_CMD} build ${DOCKER_BUILD_OPTION} -f Dockerfile.hrpsys.${UBUNTU_VERSION}_${CHOREONOID_VERSION} \
...
${BUILD_CMD} build ${DOCKER_BUILD_OPTION} -f Dockerfile.choreonoidsim.${UBUNTU_VERSION}_${CHOREONOID_VERSION} \
